...
void main() {
  testWidgets(
    'reactivating a retained surface opens and presents a new session',
    (tester) async {
      ...
      await settleVideoPlayerTasks(tester);
      final reactivatedToken =
          platform.dataSources.last.httpHeaders[warpPlaybackAttemptHeader]!;
      frames.add({'version': 1, 'attemptToken': reactivatedToken});
      await settleVideoPlayerTasks(tester);
      ...
      expect(
        ...
        greaterThan(telemetry.activations.first.generation),
      );
