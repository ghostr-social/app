...
require_threshold rust/crates/delivery/src/manager/plan/adaptive/snapshot.rs 100
...
require_threshold rust/crates/gateway/src/progressive/capabilities.rs 98.9
