...
void main() {
  test(
    'a new native session replaces warm feeds for the same viewer',
    () async {
      ...
      final port = LiveRustFeedPort(
        firstPage: [
          rustFeedUpdate(
            ...
            posts: [
              rustFeedPost(
                details: const RustFeedPostDetails(caption: 'old session'),
              ),
            ],
          ),
        ],
      ...
      port
        ...
        ..firstPage = [
          rustFeedUpdate(
            ...
            posts: [
              rustFeedPost(
                details: const RustFeedPostDetails(caption: 'new session'),
              ),
            ],
          ),
        ];
