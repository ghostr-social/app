...
void main() {
  testWidgets(
    'a canceled backward drag keeps the current player without a previous decoder',
    (tester) async {
      ...
      expect(_textureFor('p0', previousPlayer), findsNothing);
      expect(fixture.platform.disposed, contains(previousPlayer));
