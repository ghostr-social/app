...
void main() {
  testWidgets('the exact adjacent and previous players are reused on swipe', (
    tester,
  ) async {
    ...
    expect(find.byKey(const ValueKey('p0'), skipOffstage: false), findsWidgets);
    expect(fixture.platform.playerCount, 2);
    expect(fixture.platform.disposed, isNot(contains(p0)));
    ...
    expect(fixture.platform.creationsFor(fixture.url('p1')), 1);
    expect(fixture.platform.peakPlayerCount, lessThanOrEqualTo(3));
