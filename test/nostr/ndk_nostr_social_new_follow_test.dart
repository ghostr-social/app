...
void main() {
  ...
  test('one-way follow adds a missing contact exactly once', () async {
    ...
    expect(await social.follow(target), FollowOutcome.newlyFollowed);
    expect(await social.follow(target), FollowOutcome.alreadyFollowing);
