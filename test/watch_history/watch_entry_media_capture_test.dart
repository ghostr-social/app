...
void main() {
  test('a watch entry remembers every video URL and file digest', () {
    final digest = VideoSha256.tryParse('a' * 64)!;
    final post = samplePost(id: 'clip').withMedia(
    ...
    final localEntry = WatchHistoryEntry.fromPost(
      local,
      DateTime.utc(2026, 8, 3),
    );
    expect(localEntry.mediaUrls, isEmpty);
