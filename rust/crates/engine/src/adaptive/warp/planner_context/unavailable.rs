...
pub(super) const fn network_class() -> crate::origin_model::NetworkClass {
    crate::origin_model::NetworkClass::Unavailable
}

pub(super) fn is_network_class(value: &crate::origin_model::NetworkClass) -> bool {
    *value == network_class()
}
