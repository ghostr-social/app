...
use crate::discovery::feed_store::{FeedStore, FEED_POST_RETENTION};
use crate::discovery::social_graph::SocialGraph;
use crate::discovery::tests::feed_store_support::page;
use nostr_sdk::Keys;
...
fn query_page(newest: u64) -> Vec<crate::discovery::event_parsing::ParsedVideoPost> {
    page(newest, PAGE)
        .into_iter()
        .map(|mut post| {
