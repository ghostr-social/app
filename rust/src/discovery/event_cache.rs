...
pub use crate::discovery::event_cache_database::{
    client_with_event_cache, session_event_database, MAX_CACHED_EVENTS,
};
use crate::discovery::event_cache_merge::merged;
use crate::discovery::event_cache_session::EventCacheSession;
pub use crate::discovery::event_cache_session::ViewerScope;
...
impl EventCache {
    ...
    pub(crate) async fn remember_for(
        &self,
        generation: SessionGeneration,
        events: &[Event],
    ) -> bool {
