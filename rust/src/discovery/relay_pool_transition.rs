...
use crate::discovery::relay_pool_owner::{locked, RelayPoolOwner};
use crate::discovery::relay_pool_roles::RelayPoolConfiguration;
use crate::discovery::session_generation::SessionGeneration;
use nostr_sdk::PublicKey;
use tokio::sync::{OwnedMutexGuard, OwnedRwLockWriteGuard};

pub(crate) struct RelayPoolTransition {
...
impl RelayPoolOwner {
    pub(crate) async fn begin_configuration(&self) -> RelayPoolTransition {
    ...
    pub(crate) async fn begin_reset(&self) -> RelayPoolTransition {
...
impl RelayPoolTransition {
    pub(crate) async fn replace_configuration(&mut self, configuration: RelayPoolConfiguration) {
