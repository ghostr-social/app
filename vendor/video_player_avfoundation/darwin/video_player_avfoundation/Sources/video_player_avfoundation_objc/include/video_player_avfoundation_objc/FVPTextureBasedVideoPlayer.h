...
/// Reports the first newly copied non-null video frame for a Ghostr playback attempt.
@property(nonatomic, nullable, copy) void (^warpFirstFrameRenderedCallback)(void);
