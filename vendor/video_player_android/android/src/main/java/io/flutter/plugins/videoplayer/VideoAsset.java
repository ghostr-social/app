...
public abstract class VideoAsset {
  ...
  static VideoAsset fromRemoteUrl(
    ...
    WarpPlaybackAttemptHeaders.Result headers = WarpPlaybackAttemptHeaders.extract(httpHeaders);
    return new HttpVideoAsset(remoteUrl, streamingFormat, headers, userAgent);
  }
  ...
  /** Returns the WARP playback attempt associated with this asset, when present. */
  @Nullable
  String getWarpPlaybackAttemptToken() {
    return null;
  }
