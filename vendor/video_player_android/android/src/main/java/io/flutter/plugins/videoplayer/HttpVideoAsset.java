...
final class HttpVideoAsset extends VideoAsset {
  ...
  @Nullable private final String warpPlaybackAttemptToken;

  HttpVideoAsset(
      @Nullable String assetUrl,
      @NonNull StreamingFormat streamingFormat,
      @NonNull WarpPlaybackAttemptHeaders.Result headers,
      @Nullable String userAgent) {
    super(assetUrl);
    this.streamingFormat = streamingFormat;
    this.httpHeaders = headers.getRequestHeaders();
    this.userAgent = userAgent;
    this.warpPlaybackAttemptToken = headers.getAttemptToken();
  }

  @Override
  @Nullable
  String getWarpPlaybackAttemptToken() {
    return warpPlaybackAttemptToken;
  }
