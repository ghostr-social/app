...
public class VideoPlayerPlugin implements FlutterPlugin, AndroidVideoPlayerApi {
  ...
  @Nullable private EventChannel warpFirstFrameChannel;
  @Nullable private WarpFirstFrameEventStream warpFirstFrameEvents;
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
    ...
    startWarpFirstFrameEvents(binding.getBinaryMessenger());
  ...
  public long createForPlatformView(@NonNull CreationOptions options) {
    ...
    playerOptions.warpFirstFrameReporter = reporterFor(videoAsset);
  ...
  private void startWarpFirstFrameEvents(@NonNull BinaryMessenger messenger) {
    warpFirstFrameEvents = new WarpFirstFrameEventStream();
    warpFirstFrameChannel = new EventChannel(messenger, WarpFirstFrameEventStream.CHANNEL_NAME);
    warpFirstFrameChannel.setStreamHandler(warpFirstFrameEvents);
  }

  private void stopWarpFirstFrameEvents() {
    if (warpFirstFrameChannel != null) {
      warpFirstFrameChannel.setStreamHandler(null);
      warpFirstFrameChannel = null;
    }
    if (warpFirstFrameEvents != null) {
      warpFirstFrameEvents.close();
      warpFirstFrameEvents = null;
    }
  }

  @NonNull
  private WarpFirstFrameReporter reporterFor(@NonNull VideoAsset videoAsset) {
    WarpFirstFrameEventStream events = warpFirstFrameEvents;
    if (events == null) {
      return WarpFirstFrameReporter.none();
    }
    return WarpFirstFrameReporter.forAttempt(
        videoAsset.getWarpPlaybackAttemptToken(), events);
  }
